  ...
  return (
    <div className="fixed inset-0 z-20 transition-opacity  flex lg:grid-cols-5">
      <div className="flex  flex-1 overflow-hidden">
        <div className="fixed z-30 w-64 h-screen overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0">
          ...
          <nav className="mt-10">
            ...
            >
              ...
              <span className="mx-3">ADD BOOK</span>
            </a>
            ...
            >
              ...
              <span className="mx-3"> UPDATE BOOK</span>
            </a>
            ...
            >
              ...
              <span className="mx-3">DELETE BOOK</span>
            </a>
          </nav>
        </div>
              ...
              <div className="inline-block min-w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg">
                <table className="min-w-full">
                  ...
                  <tbody className="bg-white">
                    ...
                    {/* Additional user data rows go here */}
                  </tbody>
                </table>
              </div>
            </div>
